...
function AddCarpool() {
  ...
  async function handleSubmit(e) {
    ...
    starting_location.current.value = "";
    starting_address.current.value = "";
    starting_city.current.value = "";
    starting_state.current.value = "";
    starting_postalCode.current.value = "";
    target_location.current.value = "";
    target_address.current.value = "";
    target_city.current.value = "";
    target_state.current.value = "";
    target_postalCode.current.value = "";
    router.push("/");
  }
  let days = [
    "Monday",
    ...
    <ChakraProvider>
      ...
      >
        ...
        >
          ...
          <Button variant="solid" width="40%" mt="10px" onClick={handleSubmit} disabled={submitting}>
            Add Carpool
          </Button>
        </Flex>
      </Flex>
